  ...
  >
    <div class="site-container">
      <div class="flex h-18 items-center justify-between gap-4 py-4">
        <NuxtLink
          to="/"
          class="group flex items-center gap-3 transition-opacity hover:opacity-85"
        >
          <span
          ...
          <span>
            ...
            <span
              class="block text-[11px] tracking-[0.2em]"
        ...
        <div class="flex items-center gap-2">
          <NuxtLink
            to="/balls"
            class="hidden rounded-full px-4 py-2 text-sm font-semibold transition-all duration-200 md:inline-flex"
            :class="isTransparent ? 'bg-white text-black hover:bg-white/85' : 'bg-black text-white hover:bg-black/85 dark:bg-white dark:text-black dark:hover:bg-white/85'"
          >
            进入五球
          </NuxtLink>
          <ColorModeSwitch
